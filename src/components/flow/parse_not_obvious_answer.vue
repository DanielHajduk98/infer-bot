<template>
    <message-box>
        ...
        <div class="btn-container">
            <message-button :disabled="btnDisabled" @click.native="next(true)">Yes</message-button>
            <message-button :disabled="btnDisabled" @click.native="next(false)">No</message-button>
        </div>
    </message-box>
</template>
